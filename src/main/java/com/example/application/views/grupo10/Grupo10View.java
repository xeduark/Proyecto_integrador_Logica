package com.example.application.views.grupo10;
...
@PageTitle("Grupo 10")
@Route(value = "grupo-10", layout = MainLayout.class)
public class Grupo10View extends VerticalLayout {
